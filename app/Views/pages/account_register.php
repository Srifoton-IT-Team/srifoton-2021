            ...
            <div class="bg-white py-8 px-16 shadow rounded-lg sm:px-10">
                ...
                <form class="mb-0 space-y-5" action="/register/save" method="POST">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input class="w-full border border-gray-300 px-3 py-2 rounded-lg shadow-sm focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand-light"
                                   id="confirm_password" name="confirm_password" type="password" autocomplete="on"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="pt-5">
                        ...
                        <div class="mt-1">
                            <input class="w-full border border-gray-300 px-3 py-2 rounded-lg shadow-sm focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand-light"
                                   id="full_name" name="full_name" type="text" autocomplete="on" required>
                        </div>
                    </div>
                    <!--  End of Name    -->
                    <!--  NIM   -->
                    <div>
                        ...
                        <div class="mt-1">
                            <input class="w-full border border-gray-300 px-3 py-2 rounded-lg shadow-sm focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand-light"
                                   id="nim" name="nim" type="text" autocomplete="on" required>
                        </div>
                    </div>
                    <!--  End of NIM    -->
                    <!--  University   -->
                    <div>
                        ...
                        <div class="mt-1">
                            <input class="w-full border border-gray-300 px-3 py-2 rounded-lg shadow-sm focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand-light"
                                   id="university" name="university" type="text" autocomplete="on" required>
                        </div>
                    </div>
                    <!--  End of University    -->
                    <!--  Whatsapp   -->
                    <div>
                        ...
                        <div class="mt-1">
                            <input class="w-full border border-gray-300 px-3 py-2 rounded-lg shadow-sm focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand-light"
                                   id="whatsapp_num" name="whatsapp_num" type="text" autocomplete="on" required>
                        </div>
                    </div>
                    <!--  End of Whatsapp    -->
                    <div class="pt-8">
