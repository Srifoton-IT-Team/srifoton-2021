...
<section class="relative h-full pt-20 pb-12 lg:px-24 md:px-16 sm:px-8 px-4 transition-all duration-500 linear"
    ...
    <footer class="footer-2-4 font-rubik">
        <div class="lg:pb-24 pb-16 mx-auto">
            <div class="grid lg:grid-cols-4 sm:grid-cols-2 lg:gap-0 gap-y-6">
                ...
                <div class="">
                    <h2 class="title-font font-semibold text-2xl mb-5 text-white">Contact</h2>
                    <nav class="list-none list-footer space-y-5">
                        <li class="text-white">
                            <h5 class="text-lg xl:text-xl">Address</h5>
                            <a>Indralaya: Jl. Raya Palembang - Prabumulih Km. 32 Indralaya, Ogan Ilir, Sumatera Selatan,
                                Indonesia.
                                Gedung Fasilkom, Kampus Universitas Sriwijaya Indralaya 30662
                                Palembang: Jl. Srijaya Negara, Bukit Besar, Palembang, Sumatera Selatan, 30139. Gedung
                                Fasilkom, Kampus
                                Universitas Sriwijaya Palembang</a>
                        </li>
                    </nav>
                </div>
            </div>
        ...
        <div class="border-color mx-auto">
            ...
            <div class="container mx-auto flex  pt-12 flex-col lg:flex-row items-center space-y-5 lg:space-y-0">
                ...
                <nav class="flex lg:flex-row flex-col items-center text-base justify-center">
                    <p>Copyright © 2021 Srifoton IT Lead</p>
                </nav>
            </div>
        </div>
    </footer>
